...
def plotter_loop():
    ...
    while not rospy.is_shutdown():
        if len(time_data) > 0:
            ...
            ax1.set_ylim(-1.0, 1.0) # Rango fijo para ver bien las oscilaciones
            ...
            ax2.set_ylim(-1.0, 1.0) # Rango fijo
            ...
            ax3.axhline(0, color='red', linestyle='--', linewidth=2, label='Objetivo (0m)')
