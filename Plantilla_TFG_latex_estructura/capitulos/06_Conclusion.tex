...
\textbf{Grado de cumplimiento: Cumplido parcialmente, aproximadamente un 85\%.}
...
\begin{itemize}
    ...
    \item \textbf{Integración de una cámara de eventos:} estudiar la incorporación de este tipo de sensor para detectar cambios rápidos en la escena con menor latencia. Esto podría ayudar a localizar antes al UAV objetivo y aumentar la capacidad de reacción del sistema ante maniobras bruscas.
