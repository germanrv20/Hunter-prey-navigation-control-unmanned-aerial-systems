...
La metodología seguida se plantea de forma incremental. En primer lugar, se prepara un entorno reproducible basado en ROS, Gazebo, MAVROS y ArduPilot, cuya relación con el resto de módulos del sistema se sintetiza en el esquema general de la Figura \ref{fig:arquitectura_nodos}. A continuación, se configura una simulación con dos UAVs diferenciados para poder evaluar tareas de seguimiento visual. Sobre esta base se incorporan los módulos de percepción y estimación, encargados de obtener una medida visual del objetivo y suavizarla antes de alimentar el controlador. Finalmente, el sistema se valida inicialmente mediante pruebas en simulación, observando la comunicación entre nodos, la coherencia de los marcos de referencia y la respuesta del UAV ante las consignas generadas, como paso previo a una posible validación posterior con hardware real.
