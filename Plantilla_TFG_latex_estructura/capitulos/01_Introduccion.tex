...
\begin{itemize}
    ...
    \item \textbf{OE3: Integrar la arquitectura software en un entorno de simulación realista}. Implementar el sistema completo utilizando ROS como middleware de comunicación, acoplando los nodos de visión y control con el simulador físico 3D Gazebo y ArduPilot mediante simulaciones SITL (Software In The Loop).
