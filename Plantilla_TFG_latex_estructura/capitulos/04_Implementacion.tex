...
Posteriormente se lanzó la herramienta de calibración monocular, remapeando los tópicos de imagen y de cámara al nodo de captura utilizado durante las pruebas reales:
...
Una vez finalizada la calibración, se obtuvieron los parámetros de la cámara, incluyendo la matriz intrínseca y los coeficientes de distorsión. Estos valores se copiaron al archivo de configuración \texttt{camara\_params.yaml}, que posteriormente es leído por el nodo de visión para trabajar siempre con los mismos parámetros calibrados. De este modo, las pruebas reales no dependen de una calibración manual en cada ejecución y el sistema mantiene una referencia de cámara coherente con la empleada en los cálculos de proyección, compensación y estimación de distancia.
